...
{
    EnemyBulletProjectile[] GeneratePattern(Vector3 origin, Vector3 forward, int bulletCount, float speed);
}
...
public class EnemyBulletGenerator
{
    ...
    public EnemyBulletGenerator(IBulletPattern pattern)
    {
        bulletPattern = pattern;
    }

    public EnemyBulletProjectile[] GeneratePattern(Vector3 origin, int bulletCount, float speed)
    {
...
{
    public EnemyBulletProjectile[] GeneratePattern(Vector3 origin, Vector3 forward, int bulletCount, float speed)
    {
        EnemyBulletProjectile[] bullets = new EnemyBulletProjectile[bulletCount];
        ...
        for (int i = 0; i < bulletCount; i++)
        {
            ...
            bullets[i] = new EnemyBulletProjectile(origin, direction, speed);
        }
...
public class SpiralPattern : IBulletPattern
{
    public EnemyBulletProjectile[] GeneratePattern(Vector3 origin, Vector3 forward, int bulletCount, float speed)
    {
        ...
        for (int i = 0; i < bulletCount; i++)
        {
            ...
            bullets[i] = new EnemyBulletProjectile(origin + offset, direction, speed);
        }
